...
#define BYTE_CONC_HELP(BIT7,BIT6,BIT5,BIT4,BIT3,BIT2,BIT1,BIT0)     0b##BIT7##BIT6##BIT5##BIT4##BIT3##BIT2##BIT1##BIT0
#define BYTE_CONC(BIT7,BIT6,BIT5,BIT4,BIT3,BIT2,BIT1,BIT0)          BYTE_CONC_HELP(BIT7,BIT6,BIT5,BIT4,BIT3,BIT2,BIT1,BIT0)
